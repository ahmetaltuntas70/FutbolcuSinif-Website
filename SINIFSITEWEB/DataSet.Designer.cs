...
namespace SINIFSITEWEB {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class TBL_OGRENCIDataTable : global::System.Data.TypedTableBase<TBL_OGRENCIRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TBL_OGRENCIRow AddTBL_OGRENCIRow(string OGRSOYAD, string OGRAD, string OGRTELEFON, string OGRMAIL, string OGRSIFRE, string OGRFOTOGRAF, string NUMARA) {
            ...
            public string ÖĞRENCİADSOYAD {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'OGRNOTLAR\' tablosundaki \'ÖĞRENCİADSOYAD\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace SINIFSITEWEB.DataSetTableAdapters {
    ...
    public partial class TBL_OGRENCITableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [TBL_OGRENCI] ([NUMARA], [OGRSOYAD], [OGRAD], [OGRTELEFON], [OGRMAIL]" +
                ", [OGRSIFRE]) VALUES (@NUMARA, @OGRSOYAD, @OGRAD, @OGRTELEFON, @OGRMAIL, @OGRSIF" +
                "RE)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [TBL_OGRENCI] SET [NUMARA] = @NUMARA, [OGRSOYAD] = @OGRSOYAD, [OGRAD] = @O" +
                "GRAD, [OGRTELEFON] = @OGRTELEFON, [OGRMAIL] = @OGRMAIL, [OGRSIFRE] = @OGRSIFRE W" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["BootsrapSinifSiteDBConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        OGRID, NUMARA, OGRSOYAD, OGRAD, OGRTELEFON, OGRMAIL, OGRSIFRE\r\nFROM" +
                "            TBL_OGRENCI";
            ...
            this._commandCollection[2].CommandText = "SELECT        OGRSOYAD, OGRAD, OGRTELEFON, OGRMAIL, OGRSIFRE, OGRFOTOGRAF\r\nFROM  " +
                "          TBL_OGRENCI WHERE NUMARA=@NUMARA";
            ...
            this._commandCollection[3].CommandText = "INSERT INTO [TBL_OGRENCI] ([OGRSOYAD], [OGRAD], [OGRTELEFON], [OGRMAIL], [OGRSIFR" +
                "E],[OGRFOTOGRAF]) VALUES (@OGRSOYAD, @OGRAD, @OGRTELEFON, @OGRMAIL, @OGRSIFRE,@O" +
                "GRFOTOGRAF)";
            ...
            this._commandCollection[4].CommandText = "UPDATE [TBL_OGRENCI] SET [OGRSOYAD] = @OGRSOYAD, [OGRAD] = @OGRAD, [OGRTELEFON] =" +
        ...
        public virtual int Insert(string NUMARA, string OGRSOYAD, string OGRAD, string OGRTELEFON, string OGRMAIL, string OGRSIFRE) {
            if ((NUMARA == null)) {
        ...
        public virtual int Update(string NUMARA, string OGRSOYAD, string OGRAD, string OGRTELEFON, string OGRMAIL, string OGRSIFRE, int Original_OGRID) {
            if ((NUMARA == null)) {
        ...
        public virtual int OgrenciEkle(string OGRSOYAD, string OGRAD, string OGRTELEFON, string OGRMAIL, string OGRSIFRE, string OGRFOTOGRAF) {
        ...
        public virtual int OgrenciGuncelle(string OGRSOYAD, string OGRAD, string OGRTELEFON, string OGRMAIL, string OGRSIFRE, string OGRFOTOGRAF, int OGRID) {
    ...
    public partial class OGRNOTLARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT NOTID, OGRENCIID, (OGRAD+' '+ OGRSOYAD) AS 'OGRENCIADSOYAD', DERSAD, SINAV1, SINAV2, SINAV3, ORTALAMA, DURUM FROM TBL_NOTLAR INNER JOIN TBL_OGRENCI
...
ON TBL_DERSLER.DERSID=TBL_NOTLAR.DERSNID WHERE NOTID=@NOTID";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet.OGRNOTLARDataTable OgrenciNotu(string NUMARA) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((NUMARA == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
    ...
    public partial class TBL_MESAJLARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"SELECT TBL_MESAJLAR.ALICI, TBL_MESAJLAR.BASLIK, TBL_MESAJLAR.GONDEREN, TBL_MESAJLAR.ICERIK, TBL_MESAJLAR.MESAJID, TBL_MESAJLAR.TARIH FROM TBL_MESAJLAR INNER JOIN TBL_OGRENCI ON TBL_MESAJLAR.ALICI = TBL_OGRENCI.NUMARA WHERE (TBL_MESAJLAR.GONDEREN = @GONDEREN)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "SELECT TBL_MESAJLAR.ALICI, TBL_MESAJLAR.BASLIK, TBL_MESAJLAR.GONDEREN, TBL_MESAJL" +
                "AR.ICERIK, TBL_MESAJLAR.MESAJID, TBL_MESAJLAR.TARIH FROM TBL_MESAJLAR INNER JOIN" +
                " TBL_OGRENCI ON TBL_MESAJLAR.GONDEREN = TBL_OGRENCI.NUMARA WHERE (TBL_MESAJLAR.A" +
                "LICI = @ALICI)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ICERIK", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ICERIK", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1GidenKutusuOgrenci(DataSet.TBL_MESAJLARDataTable dataTable, string GONDEREN) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((GONDEREN == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT OGRAD+\' \'+OGRSOYAD FROM TBL_NOTLAR INNER JOIN TBL_OGRENCI ON\r\nTBL_NOTLAR.O" +
                "GRENCIID=TBL_OGRENCI.OGRID\r\nWHERE SINAV1=(SELECT MAX(SINAV1) FROM TBL_NOTLAR WHE" +
                "RE DERSNID=2)";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[5] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[5].Connection = this.Connection;
            this._commandCollection[5].CommandText = "SELECT OGRAD+\' \'+OGRSOYAD FROM TBL_NOTLAR INNER JOIN TBL_OGRENCI ON\r\nTBL_NOTLAR.O" +
                "GRENCIID=TBL_OGRENCI.OGRID\r\nWHERE SINAV1=(SELECT MAX(SINAV1) FROM TBL_NOTLAR WHE" +
                "RE DERSNID=3)";
            this._commandCollection[5].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[6] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[6].Connection = this.Connection;
            this._commandCollection[6].CommandText = "SELECT AVG(SINAV1) FROM TBL_NOTLAR WHERE DERSNID=2";
            this._commandCollection[6].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[7] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[7].Connection = this.Connection;
            this._commandCollection[7].CommandText = "SELECT AVG(SINAV1) FROM TBL_NOTLAR WHERE DERSNID=3";
            this._commandCollection[7].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[8] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[8].Connection = this.Connection;
            this._commandCollection[8].CommandText = "SELECT COUNT(*) FROM TBL_NOTLAR WHERE DURUM=1 AND DERSNID=2";
            this._commandCollection[8].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[9] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[9].Connection = this.Connection;
            this._commandCollection[9].CommandText = "SELECT COUNT(*) FROM TBL_NOTLAR WHERE DURUM=0 AND DERSNID=2";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> Istatistik6() {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[6];
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
